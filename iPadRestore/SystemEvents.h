...
typedef enum SystemEventsActn SystemEventsActn __attribute__((deprecated));
...
- (SystemEventsFolderAction *) attachActionToUsing:(NSString *)using_ __attribute__((deprecated));  // Attach an action to a folder
- (NSArray *) attachedScripts __attribute__((deprecated));  // List the actions attached to a folder
- (SystemEventsUIElement *) cancel __attribute__((deprecated));  // cause the target process to behave as if the UI element were cancelled
- (SystemEventsUIElement *) confirm __attribute__((deprecated));  // cause the target process to behave as if the UI element were confirmed
- (SystemEventsUIElement *) decrement __attribute__((deprecated));  // cause the target process to behave as if the UI element were decremented
- (void) doFolderActionFolderActionCode:(SystemEventsActn)folderActionCode withItemList:(id)withItemList withWindowSize:(NSRect)withWindowSize __attribute__((deprecated));  // Send a folder action code to a folder action script
- (id) doScript __attribute__((deprecated));  // Execute an OSA script.
- (SystemEventsFile *) editActionOfUsingActionName:(NSString *)usingActionName usingActionNumber:(NSInteger)usingActionNumber __attribute__((deprecated));  // Edit an action of a folder
- (SystemEventsUIElement *) increment __attribute__((deprecated));  // cause the target process to behave as if the UI element were incremented
- (void) keyDown __attribute__((deprecated));  // cause the target process to behave as if keys were held down
- (void) keyUp __attribute__((deprecated));  // cause the target process to behave as if keys were released
- (SystemEventsUIElement *) pick __attribute__((deprecated));  // cause the target process to behave as if the UI element were picked
- (SystemEventsFolderAction *) removeActionFromUsingActionName:(NSString *)usingActionName usingActionNumber:(NSInteger)usingActionNumber __attribute__((deprecated));  // Remove a folder action from a folder
